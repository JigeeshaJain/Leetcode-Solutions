class Solution:
    def leastInterval(self, tasks: List[str], n: int) -> int:
        ...
        freq = collections.Counter(tasks) #list of items wid its count of ocuurence
        print(freq)
        max_freq = max(freq.values())  #it is giving out the maximum of the count values 
        print(max_freq)
        freq = list(freq.values()) #just creating a list of only values of occurences 
        print(freq)
